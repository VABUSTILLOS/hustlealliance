export default function SpaceDetailLoading() {
  return (
    <div className="animate-pulse space-y-6 p-4 sm:p-6">
      {/* Hero cover */}
      <div className="h-32 w-full rounded-xl bg-surface-light sm:h-48" />

      {/* Title + description */}
      <div className="space-y-3">
        <div className="h-6 w-48 rounded-md bg-surface-light sm:h-7 sm:w-64" />
      ...
      <div className="flex flex-wrap gap-4">
        <div className="h-5 w-24 rounded-md bg-surface-light sm:w-28" />
        <div className="h-5 w-24 rounded-md bg-surface-light sm:w-28" />
      </div>
