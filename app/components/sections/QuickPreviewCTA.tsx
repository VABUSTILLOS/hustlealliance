      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl text-[var(--color-foreground)] uppercase leading-tight">
            Taste the <span className="bg-gradient-to-r from-[var(--color-violet)] to-[var(--color-magenta)] bg-clip-text text-transparent">knowledge</span>
            <br />
            before you commit
          </h2>
          <p className="mt-3 text-sm sm:text-base text-[var(--color-foreground-muted)] max-w-lg mx-auto">
            Every learning path has a free first lesson. No signup needed. Pick one and start learning in 5 minutes.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-3 text-xs text-[var(--color-foreground-dim)]">
