...
export default function NeonButton({
  ...
  const base =
    'relative px-6 py-3 rounded-lg font-heading font-bold text-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-accent/50 disabled:opacity-50 disabled:cursor-not-allowed';
