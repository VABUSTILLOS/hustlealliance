...
export const postTemplates: PostTemplate[] = [
  ...
  { content: 'Our MRR just crossed ${NUMBER}K for the first time. I remember when $500 felt impossible. For everyone in the $0-1K range: keep shipping, keep talking to users. It compounds.', space: 'bootstrappers', weight: 7 },
  { content: 'Closed our pre-seed round! 🚀 ${NUMBER}K led by {INVESTOR}. It took {NUMBER} meetings and {NUMBER} rejections, but we found the right partners. The Fundraising 101 path here was a game-changer — that term sheet breakdown saved us serious legal fees.', space: 'fundraising-hub', weight: 6 },
  { content: 'Just got our first enterprise customer! 6 months of pilot, security review, and legal back-and-forth. Worth every hour. Enterprise sales is a marathon, not a sprint.', space: 'saas-founders', weight: 6 },
  { content: 'We hit #1 on Product Hunt today! 🏆 {NUMBER} upvotes and counting. The community support here has been incredible. Key lesson: we spent 3 weeks building relationships with PH influencers before launch day.', space: 'growth-hacking', weight: 5 },
  ...
  // ── Insights & Hot Takes ──
  { content: 'Hot take: Most startups don\'t need to raise venture capital. We built {PRODUCT} to ${NUMBER}M ARR completely bootstrapped. The playbooks in the Growth Marketing path are all you need to get started. AMA!', space: 'bootstrappers', weight: 8 },
  ...
  { content: 'The best growth hack I\'ve found: actually talking to customers. Not surveys, not analytics — real 30-minute conversations. We learned more from 10 calls than from 6 months of Mixpanel data.', space: 'growth-hacking', weight: 6 },
  ...
  // ── Resources & Learning ──
  { content: 'Just published my first blog post about building in public. {NUMBER} months ago I was too scared to share anything. Now I have {NUMBER}K followers and 3 inbound investor inquiries. The Community-Led Growth lesson here was 🔥', space: 'growth-hacking', weight: 6 },
  { content: 'The Product-Led Growth path is incredible. Just redesigned our onboarding flow based on Module 2 and activation rate went from {NUMBER}% to {NUMBER}% in two weeks. Data doesn\'t lie 📈', space: 'saas-founders', weight: 5 },
  ...
  // ── Industry-specific ──
  { content: 'The climate tech funding landscape is changing fast. Just analyzed {NUMBER} recent deals and noticed a shift from carbon accounting toward adaptation tech. Investors are waking up to the fact that we need both mitigation AND adaptation.', space: 'climate-tech', weight: 4 },
  { content: 'Fintech regulation update: the new open banking rules are a game-changer for startups. If you\'re building in payments or lending, this creates a massive opportunity. Here\'s my analysis of what it means for early-stage founders.', space: 'fintech-builders', weight: 4 },
  { content: 'Building in health tech? The FDA just released new guidance on AI/ML-enabled devices. This is huge — it creates a clearer path for software-as-medical-device startups. Key takeaways:', space: 'health-tech', weight: 3 },
  { content: 'Women founders: I\'m compiling a list of female-focused VC funds that are actively deploying. So far I have {NUMBER} funds with open applications. DM me your email and I\'ll share the spreadsheet.', space: 'women-in-tech', weight: 5 },
  { content: 'The creator economy isn\'t just about influencers — the real opportunity is in tools for the long tail. {NUMBER} million people now consider themselves "creators," and most of them are underserved by current platforms.', space: 'creator-economy', weight: 3 },
  ...
  { content: 'What are people\'s thoughts on the EU AI Act? We\'re building an AI product and trying to figure out if we need to restructure our data pipeline before it takes effect. Any regulatory experts here?', space: 'ai-ml-builders', weight: 3 },
];
